...
namespace coen79_lab7
{
    ...
    database& database::operator= (const database &rhs) {
        ...
        std::copy(rhs.company_array, rhs.company_array + rhs.used_slots, company_array); //copy from rhs to company
    ...
    void database::reserve(size_type new_capacity) {
        ...
        std::copy(company_array, company_array + used_slots, newC); //copy from company to new
        delete[] company_array;
        company_array = newC;
    ...
    bool database::erase_item(const std::string& cName, const std::string& pName) {
        ...
        {
            company_array[c_index].erase(pName); //erase from company
            return true;
        }
        // COMPLETE THE IMPLEMENTATION...
    }
